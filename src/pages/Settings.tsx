...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    const storedBinId = localStorage.getItem("binId") || import.meta.env.VITE_BIN_ID || "";
    const storedApiKey = localStorage.getItem("apiKey") || import.meta.env.VITE_BIN_API_KEY || "";
    const storedCacheExpiry = parseInt(localStorage.getItem("cacheExpiry") || "30", 10);
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              This will force the app to fetch fresh data from the API on the next request.
            </p>
          </div>
        </CardContent>
      </Card>
